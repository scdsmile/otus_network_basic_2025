...
> S1(config)#username admin privilege 15 pass Adm1nP@55    <--- Ну и тут та же самая ошибка, в общем, вы поняли. Никогда так не делаем, а я исправил все конфигурации после, честно-честно :)
